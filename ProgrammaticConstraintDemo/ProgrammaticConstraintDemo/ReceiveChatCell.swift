...
class ReceiveChatCell: UITableViewCell {
    ...
    func settingConstraints()  {
        ...
        [
            ...
            vwMessage.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 10),
            contentView.bottomAnchor.constraint(equalTo: vwMessage.bottomAnchor, constant: 10),
            contentView.rightAnchor.constraint(greaterThanOrEqualTo: vwMessage.rightAnchor, constant: 10)
        ]
